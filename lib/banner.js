 ...
 * Styled with emoji, box-drawing characters, and gradient colors.
 *
...
function showEngines() {
    ...
    console.log(chalk.gray('    ├── 🛡️  Anti-WAF         — 30+ UAs, CF bypass, cookie sim, header mutation'));
...
function showDisclaimer() {
    ...
    console.log(dangerGradient('  ║           ⚠️  WARNING — DANGEROUS TOOL ⚠️                    ║'));
    console.log(dangerGradient('  ╚══════════════════════════════════════════════════════════════╝'));
    ...
    console.log(chalk.white('  • CFAA §1030(a)(5)(A) (US)       • Computer Misuse Act §3 (UK)'));
    console.log(chalk.white('  • UU ITE Pasal 33 (ID)           • EU Directive 2013/40 Art.4'));
    console.log(chalk.white('  • StGB §303b (DE)                • Criminal Code §430(1.1) (CA)'));
    console.log(chalk.white('  • Criminal Code §477.3 (AU)      • CMA §7 (SG)'));
...
function showAuditSummary(config) {
    ...
    table.push(
        ...
        { [chalk.cyan('⚙️  Mode')]: config.isL7 ? 'Layer 7 (Application) — 10 Methods' : 'Layer 4 (Transport) — 10 Methods' },
